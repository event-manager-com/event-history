...
public class HistoryEventController {
    ...
    public List<EventHistoryDto> getEventsByGuest(@RequestParam int ownerId, @RequestParam String guest){
        return historyService.getEventsByGuestName(ownerId, guest);
    }
}
